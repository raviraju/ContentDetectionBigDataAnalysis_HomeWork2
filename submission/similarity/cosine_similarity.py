...
if __name__ == "__main__":
    ...
    argParser.add_argument('--jsonKey', help='Optional: compute Cosine similarity on passed json key metadata')
    args = argParser.parse_args()

    if args.inputDir and args.outCSV and args.jsonKey:
        computeScoresJson(args.inputDir, args.outCSV, args.accept, args.jsonKey)
